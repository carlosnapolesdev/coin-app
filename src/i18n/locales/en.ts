const en = {
  ...
  tagInput: {
    ...
    usageCount: '{count} use | {count} uses',
  },
  tags: {
    usageCount: '{count} use | {count} uses',
  },
  ...
  auth: {
    ...
    login: {
      ...
      accountCreatedMessage: 'Account created. We emailed you a link to confirm your address: confirm it before signing in.',
      passwordResetMessage: 'Password reset successfully. Sign in with your new password.',
      genericError: 'Unable to sign in right now.',
      notVerified: 'You need to confirm your email address before signing in.',
      resendVerification: 'Resend the confirmation email',
      resendSent: 'If the account exists and is unconfirmed, we have sent a new link.',
      resendFailed: 'We could not resend the confirmation. Check that you typed your email address above.',
    ...
    verifyEmail: {
      ...
      invalidLink: 'This link is invalid or has expired. Request a new one from the sign-in screen.',
    ...
    register: {
      ...
      step4: {
        ...
        subtitle: "Here's what you'll get. When you continue we'll create your account and email you a link to confirm your address.",
        accountActive: 'Secure account',
        accountActiveDesc: 'Security and encryption enabled',
  ...
  settings: {
    ...
    tags: {
      title: 'Manage tags',
      subtitle: 'Rename or remove tags used by your transactions.',
      empty: 'No tags yet. Add tags to a transaction to see them here.',
      loadError: 'Unable to load your tags right now.',
      rename: 'Rename',
      delete: 'Delete',
      renamePrompt: 'Tag name',
      confirmDeleteTitle: 'Delete tag?',
      confirmDelete: 'Delete “{name}” from every transaction?',
      toast: {
        renamed: 'Tag renamed',
        deleted: 'Tag deleted',
        error: 'Unable to update the tag. Please try again.',
      },
    },
    legal: {
      title: 'Legal',
